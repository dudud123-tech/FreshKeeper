...
const LATEST_ANDROID_VERSION_CODE = 24;
...
const ANDROID_WHATS_NEW = {
  ...
  items: [
    "만료·임박 상품이 냉장·냉동·실온 어디에 있는지 홈에서 한눈에 볼 수 있어요",
    "상품명을 누르면 사진과 정보를 큰 카드로 볼 수 있어요",
    "냉장·냉동·실온만 골라서 보관함을 볼 수 있어요",
    "먹는 일정에서 수정하는 방법을 하나로 정리했어요",
    "글자를 크게 설정한 기기에서 화면이 어긋나던 문제를 고쳤어요"
  ]
};
